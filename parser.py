...
Nome do extra: [nome do cobrador — quem aparece para trabalhar]
Nome de quem tá cobrindo: [nome do coberto — quem está ausente]
Motivo: [motivo]
...
- No FORMATO 1: "Nome do extra" = COBRADOR (quem aparece para trabalhar), "Nome de quem tá cobrindo" = COBERTO (quem está ausente)
